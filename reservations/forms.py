...
class BookingForm(forms.ModelForm):
    ...
    class Meta:
        model = Booking
        fields = ['name', 'email', 'phone', 'reservation_date',
                  'number_of_guests', 'special_requests', 'table']
        widgets = {
    ...
    def clean_phone(self):
        ...
        if not re.match(pattern, phone):
            raise ValidationError("Invalid phone number. Must contain 7-15 digits and may start with '+'.")
        return phone
